...
# Title
st.markdown(
    "<h1 style='text-align: center; color: #4CAF50;'>🎓 Student Performance Prediction Dashboard</h1>", 
...
with tab2:
    ...
    sns.regplot(x="Hours Studied", y="Performance Index", data=df, ax=axes[0],
    ...
    sns.regplot(x="Sleep Hours", y="Performance Index", data=df, ax=axes[1],
